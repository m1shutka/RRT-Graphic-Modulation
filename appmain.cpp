...
void WndAddMenu(HWND hWnd)
{
	...
	AppendMenu(SubMenu, MF_STRING, OnMenuSaveClicked, L"Save Scene");
	AppendMenu(SubMenu, MF_STRING, OnMenuImportClicked, L"Load Scene");
...
{
	WNDCLASS AppMainClass = WndClass((HBRUSH)COLOR_WINDOW, LoadCursor(NULL, IDC_ARROW), hInst, LoadIcon(NULL, IDI_APPLICATION), L"WndClass", AppMainProc);
